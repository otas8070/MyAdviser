...
public class Century extends Activity {
    ...
    public void Shogen(View v) {
        PDFView pdfView = (PDFView) findViewById(R.id.pdfView);
        pdfView.fromAsset("centry_s.pdf")
                .defaultPage(1)
                .showMinimap(false)
                .enableSwipe(true)
                .load();
    ...
    public void Soubi(View v) {
        PDFView pdfView = (PDFView) findViewById(R.id.pdfView);
        pdfView.fromAsset("centry_so.pdf")
                .defaultPage(1)
                .showMinimap(false)
                .enableSwipe(true)
                .load();
    ...
    public void GladeSoubi(View v) {
        PDFView pdfView = (PDFView) findViewById(R.id.pdfView);
        pdfView.fromAsset("centry_gs.pdf")
                .defaultPage(1)
                .showMinimap(false)
                .enableSwipe(true)
                .load();
